...
jQuery(document).ready(function(){
	new JATooltips ([$('diffview-status-new')], {
		content: '<?php echo JText::_("THESE_FILES_ARE_NEWLY_ADDED_TO_NEW_VERSION_THESE_WILL_BE_ADDED_TO_USER_SITE_ON_UPGRADE", true); ?>'
	});
	new JATooltips ([$('diffview-status-bmodified')], {
		content: '<?php echo JText::sprintf("CONFLICTED_FILES_MODIFIED_BY_YOU__AND_UPDATED_IN_S_AS_WELL_THIS_FILE_WILL_BE_REPLACED_WITH_S_VERSION_FILE_AFTER_THE_UPGRADE_YOU_NEED_TO_TAKE_BACKUP_OF_THIS_FILE_AND_REAPPLY_ALL_OF_YOUR_CUSTOMIZATIONS_TO_THE_NEW_FILE", $compareVersion, $compareVersion); ?>'
	});
	new JATooltips ([$('diffview-status-updated')], {
		content: '<?php echo JText::sprintf("THESE_FILES_ARE_CHANGED_IN_S_AND_ARE_NOT_MODIFIED_BY_YOU_IN_YOUR_LIVE_SITE_THESE_WILL_BE_UPDATED_TO_USER_SITE_ON_UPGRADE", $compareVersion, $compareVersion); ?>'
	});
	new JATooltips ([$('diffview-status-removed')], {
		content: '<?php echo JText::sprintf("THESE_FILES_ARE_DELETED_IN_S_VERSION_THESE_WILL_BE_REMOVED_FROM_USER_SITE_ON_UPGRADE", $compareVersion, $compareVersion); ?>'
	});
	new JATooltips ([$('diffview-status-umodified')], {
		content: '<?php echo JText::sprintf("MODIFIED_BY_YOU_ONLY_THERE_IS_NO_CODE_CHANGE_FROM_VERSION_S_TO_S_THIS_FILE_WILL_NOT_BE_OVERWRITTEN_YOUR_CUSTOMIZATION_WILL_BE_RETAINED_AFTER_THE_UPGRADE_HOWEVER_IF_YOUR_CUSTOMIZATION_CAUSE_THE_ERROR_YOU_WILL_NEED_TO_OVERWRITE_WITH_THE_CLEAN_FILE_OF_VERSION_S_AND_THEN_REAPPLY_YOUR_CUSTOMIZATION", $this->obj->version, $compareVersion, $compareVersion); ?>'
	});
	new JATooltips ([$('diffview-status-ucreated')], {
		content: '<?php echo JText::_("THESE_FILES_ARE_CUSTOM_CREATED_BY_USER__OR_WERE_MOVED_TO_NEW_DIRECTORY_DURING_THE_INSTALLATION_PROCESS_NONEXTENSION_FILES_WILL_NOT_BE_AFFECTED_EXTENSION_FILES_WHICH_NEEDS_TO_MOVE_TO_OTHER_FOLDERS_DURING_INSTALLATION_WILL_BE_OVERWRITTEN", true); ?>'
	});
	new JATooltips ([$('diffview-status-nochange')], {
		content: '<?php echo JText::_("THESE_FILES_ARE_NOT_CHANGED_BETWEEN_THE_OLD_AND_NEW_VERSION_THEY_WILL_NOT_BE_AFFECTED_BY_UPGRADE", true); ?>'
	});
});
/*]]>*/
</script>
