...
function submitbutton(pressbutton) {
	...
	if (pressbutton == 'add' || pressbutton == 'edit') {
		jaCreatePopup('<?php echo $linkNew; ?>', 400, 300, '<?php echo JText::_("NEW_REMOTE_SERVICE", true)?>');
...
<form action="index.php" method="post" name="adminForm">
  ...
  <table class="adminlist ja-uc">
	...
	for ($i=0;$i<$count; $i++) {
		...
		$title=JText::_('EDIT_SERVICES')." ID: ".$item->id;	
    ...
    <tr>
      ...
      <td align="center"><a href="#" title="<?php echo JText::_('EDIT'); ?>" onclick="jaCreatePopup('<?php echo $linkEdit; ?>', 400, 300, '<?php echo JText::_($item->ws_name . " [Edit]", true)?>'); return false;"><?php echo JText::_('EDIT'); ?></a></td>
    </tr>
    <?php }?>
    <?php }else{ ?>
    <tr>
