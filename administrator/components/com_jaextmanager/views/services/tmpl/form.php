  ...
  <input type="hidden" id="ws_mode" name="ws_mode" value="<?php echo $item->ws_mode; ?>" />
    <fieldset>
        ...
        <table class="admintable" width="100%">
          <tr>
            <td width="30%" class="key" align="right" valign="top"><?php echo JText::_('SERVICE_NAME' ); ?> <span style="color:red;">*</span>: </td>
            <td width="70%">
      			<input type="text" id="ws_name" name="ws_name" size='50' value="<?php echo $item->ws_name; ?>" />            </td>
          </tr>
  		  <?php if($item->ws_mode != 'local'): ?>
          <tr>
            <td class="key" align="right" valign="top"><?php echo JText::_('SERVICE_URL' ); ?> <span style="color:red;">*</span>: </td>
            <td>
